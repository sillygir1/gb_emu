...
/// @brief Test bit u3 in the byte pointed by HL, set the zero flag if bit not
/// set.
/// @param system System struct
/// @param u3
void BIT_u3_HL(System *system, uint8_t u3);

/// @brief Set bit u3 in register r8 to 0. Bit 0 is the rightmost one, bit 7 the
/// leftmost one.
/// @param system System struct
/// @param u3
/// @param r8
...
/// @brief Set bit u3 in the byte pointed by HL to 0. Bit 0 is the rightmost
/// one, bit 7 the leftmost one.
/// @param system System struct
/// @param u3
void RES_u3_HL(System *system, uint8_t u3);

/// @brief Set bit u3 in register r8 to 1. Bit 0 is the rightmost one, bit 7 the
/// leftmost one.
/// @param system System struct
/// @param u3
/// @param r8
...
/// @brief Set bit u3 in the byte pointed by HL to 1. Bit 0 is the rightmost
/// one, bit 7 the leftmost one.
/// @param system System struct
/// @param u3
...
/// @brief Store value in register A into the byte pointed by HL and increment
/// HL afterwards.
/// @param system
void LD_HLI_A(System *system);

/// @brief Store value in register A into the byte pointed by HL and decrement
/// HL afterwards.
/// @param system
void LD_HLD_A(System *system);

/// @brief Load value into register A from the byte pointed by HL and increment
/// HL afterwards.
/// @param system
void LD_A_HLI(System *system);

/// @brief Load value into register A from the byte pointed by HL and decrement
/// HL afterwards.
/// @param system
...
/// @brief Decimal Adjust Accumulator to get a correct BCD representation after
